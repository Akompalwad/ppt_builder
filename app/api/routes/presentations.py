...
def edit(presentation_id:str,slide_number:int,instruction:str, session_id: str = Depends(require_active_session)):
    try: spec,number=service.edit(presentation_id,slide_number,instruction,session_id); return {"version_number":number,"slide":spec.slides[slide_number-1]}
